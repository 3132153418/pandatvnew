...
public class HistoryDao extends AbstractDao<History, Long> {
    ...
    public static class Properties {
        ...
        public final static Property VoideLength = new Property(3, String.class, "voideLength", false, "voideLength");
        public final static Property DayTime = new Property(4, String.class, "dayTime", false, "dayTime");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HISTORY\" (" + //
                ...
                "\"voideLength\" TEXT," + // 3: voideLength
                "\"dayTime\" TEXT," + // 4: dayTime
                "\"flag\" TEXT);"); // 5: flag
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, History entity) {
        ...
        String voideLength = entity.getVoideLength();
        if (voideLength != null) {
            stmt.bindString(4, voideLength);
        }
    ...
    public History readEntity(Cursor cursor, int offset) {
        History entity = new History( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // voideLength
    ...
    public void readEntity(Cursor cursor, History entity, int offset) {
        ...
        entity.setVoideLength(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
