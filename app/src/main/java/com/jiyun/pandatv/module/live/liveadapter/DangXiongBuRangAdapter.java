 ...
 */
public class DangXiongBuRangAdapter extends BaseAdapter<Live_DangXiongBuRangBean.VideoBean> {
    public DangXiongBuRangAdapter(Context context, List<Live_DangXiongBuRangBean.VideoBean> datas) {
        super(context, R.layout.paper_after_item, datas);
    }

    @Override
    public void convert(ViewHolder holder, Live_DangXiongBuRangBean.VideoBean videoBean) {
