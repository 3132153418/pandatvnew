 ...
 */
public class PandaYuanChuangAdapter extends BaseAdapter<Live_YuanChuangBean.VideoBean> {
    public PandaYuanChuangAdapter(Context context,List<Live_YuanChuangBean.VideoBean> datas) {
        super(context, R.layout.paper_after_item, datas);
    }

    @Override
    public void convert(ViewHolder holder, Live_YuanChuangBean.VideoBean videoBean) {
