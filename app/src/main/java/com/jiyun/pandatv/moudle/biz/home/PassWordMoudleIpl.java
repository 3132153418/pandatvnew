...
public class PassWordMoudleIpl implements PassWordMoudle {
    @Override
    public void setPwd(MyLoginCallBack callBack) {
        EmileRegUtils.getInstance().loginPost(Urls.EMILEYANZHENG,null,null,callBack);
    }

    @Override
    public void setPwdYz(String number, String yanzm, MyLogCallBack callBack) {
    ...
    @Override
    public void findPwdBtn(String number, String yanzm, String pwd, MyLogCallBack callBack) {
